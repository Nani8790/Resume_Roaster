...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      // Provide helpful message for Google OAuth users
      if (errorMessage.includes('Invalid email or password')) {
        errorMessage += '. If you signed up with Google, please use the "Continue with Google" button below.';
      }
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Sign in to your Resume Roaster account</p>
        </div>
      </div>
