@echo off
REM 🔒 Secure Admin Dashboard - Git Branch Setup (Windows)
REM This script sets up a separate Git branch for admin functionality
...
REM Create and switch to admin branch
echo 📝 Creating admin-dashboard branch...
git checkout -b admin-dashboard 2>nul || git checkout admin-dashboard

REM Add admin files to the branch
...
git add -f admin/setup-admin-branch.bat

REM Update main app files that reference admin
git add src/App.jsx
git add src/components/Header.jsx
git add server/index.js
git add test-admin-dashboard.js

REM Commit admin functionality
echo 💾 Committing admin dashboard...
git commit -m "🔒 Add secure admin dashboard - Admin dashboard accessible only via /admin/7780488674 - Email-based admin authorization - Separate admin codebase in /admin folder - Security logging and access control - Dark theme admin interface - Comprehensive user management - Revenue and analytics tracking - System health monitoring"
